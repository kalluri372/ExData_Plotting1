...
plot( power_2d$NewDateTime, 
      ...
      type = "l" )
plot( power_2d$NewDateTime, 
      power_2d$Sub_metering_1, 
      xlab = "", 
      ylab = "Energy sub metering", 
      type = "l" )
lines( power_2d$NewDateTime, power_2d$Sub_metering_2, col = "red" )
lines( power_2d$NewDateTime, power_2d$Sub_metering_3, col = "blue" )
legend( "topright", 
        lty = 1, 
        col = c("black", "blue", "red"), 
        legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3") )
plot( power_2d$NewDateTime, 
      power_2d$Global_reactive_power, 
      xlab = "datetime", 
