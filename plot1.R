...
# Sub_metering_3               NewDate 
#          25979                     0 

        # extract rows of desired 2 days 
power_2d <- 
 power_all[ ( (power_all$NewDate == "2007-02-01") 
               | (power_all$NewDate == "2007-02-02") ), ] 
names(power_2d)
# [1] "Date"                  "Time"                  "Global_active_power"  
# [4] "Global_reactive_power" "Voltage"               "Global_intensity"     
# [7] "Sub_metering_1"        "Sub_metering_2"        "Sub_metering_3"       
...
# Sub_metering_1 Sub_metering_2 Sub_metering_3    NewDate
# 66637              0              0              0 2007-02-01
# 66638              0              0              0 2007-02-01
# 66639              0              0              0 2007-02-01
# 66640              0              0              0 2007-02-01
# 66641              0              0              0 2007-02-01
# 66642              0              0              0 2007-02-01
nrow(power_2d)
# [1] 2880
...
hist( power_2d$Global_active_power, 
      col = "red", 
